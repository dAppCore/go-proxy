...
func TestProxy_CustomDiffStats_Snapshot_Ugly(t *testing.T) {
	// target tokens: CustomDiffStats Snapshot
	// target symbol: CustomDiffStats_Snapshot
...
func TestProxy_CustomDiffStats_bucketLocked_Ugly(t *testing.T) {
	// target tokens: CustomDiffStats bucketLocked
	// target symbol: CustomDiffStats_bucketLocked
	var buckets CustomDiffBuckets
