...
func TestServer_Proxy_Start_Good(t *testing.T) {
	cfg := &Config{
		Mode:    "simple",
		Workers: WorkersByRigID,
...
func TestServer_Proxy_Start_Bad(t *testing.T) {
	var p *Proxy
	p.Start()
	if p != nil {
...
func TestServer_Proxy_Start_Ugly(t *testing.T) {
	cfg := &Config{
		Mode:    "simple",
		Workers: WorkersByRigID,
		Bind:    []BindAddr{{Host: "127.0.0.1", Port: 0}},
...
func TestServer_listen_BlankHost_Bad(t *testing.T) {
	// target tokens: listen BlankHost
	// target symbol: listen_BlankHost
...
func TestServer_Server_Start_Good(t *testing.T) {
...
func TestServer_Server_Start_Bad(t *testing.T) {
	var srv *Server
	srv.Start()
	if srv != nil {
...
func TestServer_Server_Start_Ugly(t *testing.T) {
	dir := t.TempDir()
	certFile, keyFile := writeTestCertPair(t, dir)
