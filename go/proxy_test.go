...
func TestProxy_Proxy_WorkerRecords_Good(t *testing.T) {
...
func TestProxy_Proxy_WorkerRecords_Bad(t *testing.T) {
	var p *Proxy
...
func TestProxy_Proxy_WorkerRecords_Ugly(t *testing.T) {
	p := &Proxy{}
	if got := p.WorkerRecords(); got != nil {
...
func TestProxy_Proxy_MinerCount_Good(t *testing.T) {
	stats := NewStats()
...
func TestProxy_Proxy_MinerCount_Bad(t *testing.T) {
	var p *Proxy
	now, max := p.MinerCount()
	if now != 0 || max != 0 {
...
func TestProxy_Proxy_MinerCount_Ugly(t *testing.T) {
	p := &Proxy{}
	now, max := p.MinerCount()
	if now != 0 || max != 0 {
...
func TestProxy_Proxy_Upstreams_Good(t *testing.T) {
...
func TestProxy_Proxy_Upstreams_Bad(t *testing.T) {
	var p *Proxy
...
func TestProxy_Proxy_Upstreams_Ugly(t *testing.T) {
	p := &Proxy{}
	if got := p.Upstreams(); got != (UpstreamStats{}) {
...
func TestProxy_Proxy_Events_Good(t *testing.T) {
	bus := NewEventBus()
	p := &Proxy{events: bus}
...
func TestProxy_Proxy_Events_Bad(t *testing.T) {
	var p *Proxy
...
func TestProxy_Proxy_Events_Ugly(t *testing.T) {
	p := &Proxy{}
	if got := p.Events(); got != nil {
