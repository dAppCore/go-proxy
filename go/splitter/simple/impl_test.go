...
func TestImpl_SimpleSplitter_OnLogin_Good(t *testing.T) {
	...
	miner := &proxy.Miner{}
	job := proxy.Job{JobID: "job-1", Blob: repeatString("0", 160), Target: "b88d0600"}
	mapper := &SimpleMapper{
		id:         7,
		strategy:   activeStrategy{},
		currentJob: job,
...
func TestSimpleSplitter_Upstreams_RecoveryResetsStopped_Good(t *testing.T) {
	...
	mapper.OnJob(proxy.Job{JobID: "job-1", Blob: repeatString("0", 160), Target: "b88d0600"})
...
func TestImpl_SimpleMapper_OnJob_Ugly(t *testing.T) {
	...
	mapper.OnJob(proxy.Job{JobID: "next", ClientID: "session-1", Blob: repeatString("0", 160), Target: "b88d0600"})
...
func TestImpl_SimpleMapper_OnResultAccepted_Bad(t *testing.T) {
	...
	mapper := &SimpleMapper{
		miner:      miner,
		currentJob: proxy.Job{JobID: "job-1", Blob: repeatString("0", 160), Target: "b88d0600"},
		events:     bus,
...
func TestSimpleMapper_Submit_UnavailableStrategy_Bad(t *testing.T) {
	...
	mapper.currentJob = proxy.Job{JobID: "job-1", Blob: repeatString("0", 160), Target: "b88d0600"}
	mapper.miner = miner
...
func TestSimpleMapper_OnJob_PreservesPreviousJobForSamePoolSession_Good(t *testing.T) {
	...
	mapper.OnJob(proxy.Job{JobID: "job-2", Blob: repeatString("0", 160), Target: "b88d0600", ClientID: "session-a"})
...
func TestSimpleMapper_OnJob_ResetsPreviousJobAcrossPoolSessions_Ugly(t *testing.T) {
	...
	mapper.OnJob(proxy.Job{JobID: "job-2", Blob: repeatString("0", 160), Target: "b88d0600", ClientID: "session-b"})
...
func TestSimpleMapper_OnJob_ResetsPreviousJobWithoutClientID_Bad(t *testing.T) {
	...
	mapper.OnJob(proxy.Job{JobID: "job-2", Blob: repeatString("0", 160), Target: "b88d0600"})
...
func TestImpl_NewSimpleSplitter_Good(t *testing.T) {
	target := "NewSimpleSplitter"
	variant := "Good"
...
func TestImpl_NewSimpleSplitter_Bad(t *testing.T) {
	target := "NewSimpleSplitter"
	variant := "Bad"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
...
func TestImpl_NewSimpleSplitter_Ugly(t *testing.T) {
	target := "NewSimpleSplitter"
	variant := "Ugly"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
...
func TestImpl_SimpleSplitter_Connect_Good(t *testing.T) {
	// target tokens: SimpleSplitter Connect
	// target symbol: SimpleSplitter_Connect
	target := "SimpleSplitter_Connect"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_SimpleSplitter_OnClose_Good(t *testing.T) {
	// target tokens: SimpleSplitter OnClose
	// target symbol: SimpleSplitter_OnClose
	target := "SimpleSplitter_OnClose"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_SimpleSplitter_GC_Good(t *testing.T) {
	// target tokens: SimpleSplitter GC
	// target symbol: SimpleSplitter_GC
	target := "SimpleSplitter_GC"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_SimpleSplitter_Tick_Good(t *testing.T) {
	// target tokens: SimpleSplitter Tick
	// target symbol: SimpleSplitter_Tick
	target := "SimpleSplitter_Tick"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_SimpleSplitter_Disconnect_Good(t *testing.T) {
	// target tokens: SimpleSplitter Disconnect
	// target symbol: SimpleSplitter_Disconnect
	target := "SimpleSplitter_Disconnect"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_SimpleSplitter_ReloadPools_Good(t *testing.T) {
	// target tokens: SimpleSplitter ReloadPools
	// target symbol: SimpleSplitter_ReloadPools
	target := "SimpleSplitter_ReloadPools"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_SimpleMapper_OnDisconnect_Good(t *testing.T) {
	// target tokens: SimpleMapper OnDisconnect
	// target symbol: SimpleMapper_OnDisconnect
	target := "SimpleMapper_OnDisconnect"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
