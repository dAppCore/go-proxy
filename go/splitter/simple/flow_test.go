...
func TestFlow_SimpleSplitter_OnClose_Good(t *testing.T) {
...
func TestFlow_SimpleSplitter_Connect_Good(t *testing.T) {
...
func TestFlow_SimpleSplitter_Connect_Bad(t *testing.T) {
...
func TestFlow_SimpleSplitter_Connect_Ugly(t *testing.T) {
	splitter := NewSimpleSplitter(&proxy.Config{ReuseTimeout: 30}, proxy.NewEventBus(), func(pool.StratumListener) pool.Strategy {
...
func TestFlow_SimpleSplitter_OnClose_Bad(t *testing.T) {
	var splitter *SimpleSplitter
...
func TestFlow_SimpleSplitter_OnClose_Ugly(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
...
func TestFlow_SimpleSplitter_GC_Good(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
...
func TestFlow_SimpleSplitter_GC_Bad(t *testing.T) {
	var splitter *SimpleSplitter
	splitter.GC()
	if splitter != nil {
		t.Fatal("expected nil splitter to remain nil")
...
func TestFlow_SimpleSplitter_GC_Ugly(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
	splitter := NewSimpleSplitter(&proxy.Config{ReuseTimeout: 30}, proxy.NewEventBus(), func(pool.StratumListener) pool.Strategy {
		return spy
	})
...
func TestFlow_SimpleSplitter_Tick_Good(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
	splitter := NewSimpleSplitter(&proxy.Config{ReuseTimeout: 1}, proxy.NewEventBus(), func(pool.StratumListener) pool.Strategy {
		return spy
	})
...
func TestFlow_SimpleSplitter_Tick_Bad(t *testing.T) {
	var splitter *SimpleSplitter
	splitter.Tick(1)
	if splitter != nil {
		t.Fatal("expected nil splitter to remain nil")
...
func TestFlow_SimpleSplitter_Tick_Ugly(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
	splitter := NewSimpleSplitter(&proxy.Config{ReuseTimeout: 1}, proxy.NewEventBus(), func(pool.StratumListener) pool.Strategy {
		return spy
	})
...
func TestFlow_SimpleSplitter_Disconnect_Good(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
	splitter := NewSimpleSplitter(&proxy.Config{ReuseTimeout: 30}, proxy.NewEventBus(), func(pool.StratumListener) pool.Strategy {
		return spy
	})
...
func TestFlow_SimpleSplitter_Disconnect_Bad(t *testing.T) {
	var splitter *SimpleSplitter
	splitter.Disconnect()
	if splitter != nil {
		t.Fatal("expected nil splitter to remain nil")
...
func TestFlow_SimpleSplitter_Disconnect_Ugly(t *testing.T) {
	spy := &simpleStrategySpy{active: true}
	splitter := NewSimpleSplitter(&proxy.Config{ReuseTimeout: 30}, proxy.NewEventBus(), func(pool.StratumListener) pool.Strategy {
		return spy
	})
...
func TestFlow_SimpleMapper_OnDisconnect_Good(t *testing.T) {
