...
func TestReload_NonceSplitter_ReloadPools_Good(t *testing.T) {
...
func TestReload_NonceSplitter_ReloadPools_Bad(t *testing.T) {
	splitter := &NonceSplitter{
		mappers: []*NonceMapper{
			{strategy: nil},
		},
...
func TestReload_NonceSplitter_ReloadPools_Ugly(t *testing.T) {
