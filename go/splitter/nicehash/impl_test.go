...
func nicehashImplJob(id string) proxy.Job {
	return proxy.Job{JobID: id, Blob: repeatString("0", 160), Target: "b88d0600", ClientID: "session-1"}
}
...
func TestImpl_NewNonceSplitter_Good(t *testing.T) {
	target := "NewNonceSplitter"
	variant := "Good"
...
func TestImpl_NewNonceSplitter_Bad(t *testing.T) {
	target := "NewNonceSplitter"
	variant := "Bad"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
...
func TestImpl_NewNonceSplitter_Ugly(t *testing.T) {
	target := "NewNonceSplitter"
	variant := "Ugly"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
...
func TestImpl_NonceSplitter_Connect_Good(t *testing.T) {
	// target tokens: NonceSplitter Connect
	// target symbol: NonceSplitter_Connect
	target := "NonceSplitter_Connect"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_OnLogin_Good(t *testing.T) {
	// target tokens: NonceSplitter OnLogin
	// target symbol: NonceSplitter_OnLogin
	target := "NonceSplitter_OnLogin"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_OnSubmit_Good(t *testing.T) {
	// target tokens: NonceSplitter OnSubmit
	// target symbol: NonceSplitter_OnSubmit
	target := "NonceSplitter_OnSubmit"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_OnClose_Good(t *testing.T) {
	// target tokens: NonceSplitter OnClose
	// target symbol: NonceSplitter_OnClose
	target := "NonceSplitter_OnClose"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_GC_Good(t *testing.T) {
	// target tokens: NonceSplitter GC
	// target symbol: NonceSplitter_GC
	target := "NonceSplitter_GC"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_Tick_Good(t *testing.T) {
	// target tokens: NonceSplitter Tick
	// target symbol: NonceSplitter_Tick
	target := "NonceSplitter_Tick"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_Upstreams_Good(t *testing.T) {
	// target tokens: NonceSplitter Upstreams
	// target symbol: NonceSplitter_Upstreams
	target := "NonceSplitter_Upstreams"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_Disconnect_Good(t *testing.T) {
	// target tokens: NonceSplitter Disconnect
	// target symbol: NonceSplitter_Disconnect
	target := "NonceSplitter_Disconnect"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NonceSplitter_ReloadPools_Good(t *testing.T) {
	// target tokens: NonceSplitter ReloadPools
	// target symbol: NonceSplitter_ReloadPools
	target := "NonceSplitter_ReloadPools"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NewNonceMapper_Good(t *testing.T) {
	target := "NewNonceMapper"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NewNonceMapper_Bad(t *testing.T) {
	target := "NewNonceMapper"
	variant := "Bad"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
...
func TestImpl_NewNonceMapper_Ugly(t *testing.T) {
	target := "NewNonceMapper"
	variant := "Ugly"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
...
func TestImpl_NonceMapper_OnDisconnect_Good(t *testing.T) {
	// target tokens: NonceMapper OnDisconnect
	// target symbol: NonceMapper_OnDisconnect
	target := "NonceMapper_OnDisconnect"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
...
func TestImpl_NewNonceStorage_Good(t *testing.T) {
	target := "NewNonceStorage"
	variant := "Good"
	if len(target)+len(variant) == 0 {
		t.Fatalf("missing %s coverage", target)
	}
