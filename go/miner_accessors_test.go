...
func TestMinerAccessors_Miner_IP_Good(t *testing.T) {
...
func TestMinerAccessors_Miner_IP_Bad(t *testing.T) {
	miner := &Miner{}
	if got := miner.IP(); got != "" {
...
func TestMinerAccessors_Miner_IP_Ugly(t *testing.T) {
