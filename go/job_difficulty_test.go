...
func TestJobDifficulty_Job_DifficultyFromTarget_Good(t *testing.T) {
...
func TestJobDifficulty_Job_DifficultyFromTarget_Bad(t *testing.T) {
	cases := []Job{
		{Target: ""},
		{Target: "123"},
		{Target: "zzzzzzzz"},
...
func TestJobDifficulty_Job_DifficultyFromTarget_Ugly(t *testing.T) {
