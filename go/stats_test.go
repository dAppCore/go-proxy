...
func TestStats_Stats_OnAccept_Good(t *testing.T) {
	stats := NewStats()
...
func TestStats_Stats_OnAccept_Ugly(t *testing.T) {
	stats := NewStats()
...
func TestStats_Stats_OnReject_Good(t *testing.T) {
	stats := NewStats()
...
func TestStats_Stats_OnReject_Bad(t *testing.T) {
	stats := NewStats()
...
func TestStats_Stats_OnReject_Ugly(t *testing.T) {
...
//	stats.Tick()
//	summary := stats.Summary()
func TestStats_Stats_Tick_Good(t *testing.T) {
	stats := NewStats()
...
func TestStats_Stats_Tick_Bad(t *testing.T) {
	var stats *Stats
	stats.Tick()
	if stats != nil {
...
func TestStats_Stats_Tick_Ugly(t *testing.T) {
	var stats Stats
...
//	stats.OnLogin(proxy.Event{Miner: &proxy.Miner{}})
//	stats.OnClose(proxy.Event{Miner: &proxy.Miner{}})
func TestStats_Stats_OnClose_Good(t *testing.T) {
	stats := NewStats()
	miner := &Miner{}
...
func TestStats_Stats_OnClose_Bad(t *testing.T) {
	var stats *Stats
	stats.OnClose(Event{})
...
func TestStats_Stats_OnClose_Ugly(t *testing.T) {
	stats := NewStats()
	miner := &Miner{}
...
func TestStats_Stats_Summary_Good(t *testing.T) {
	stats := NewStats()
...
func TestStats_Stats_Summary_Bad(t *testing.T) {
	var stats *Stats
...
func TestStats_Stats_Summary_Ugly(t *testing.T) {
	var stats Stats
