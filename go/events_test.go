...
func TestEvents_EventBus_Subscribe_Good(t *testing.T) {
	bus := NewEventBus()
	order := make([]int, 0, 2)
...
func TestEvents_EventBus_Subscribe_Bad(t *testing.T) {
	var bus *EventBus
...
func TestEvents_EventBus_Subscribe_Ugly(t *testing.T) {
	var bus EventBus
	called := 0
...
func TestEvents_EventBus_Dispatch_Good(t *testing.T) {
	bus := NewEventBus()
	got := make([]string, 0, 1)
...
func TestEvents_EventBus_Dispatch_Bad(t *testing.T) {
	var bus *EventBus
...
func TestEvents_EventBus_Dispatch_Ugly(t *testing.T) {
	bus := NewEventBus()
	called := 0
