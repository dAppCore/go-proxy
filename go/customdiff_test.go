...
func TestCustomdiff_CustomDiff_OnLogin_Good(t *testing.T) {
...
func TestCustomdiff_CustomDiff_OnLogin_Bad(t *testing.T) {
	cd := NewCustomDiff(10000)
	miner := &Miner{user: "WALLET"}
...
func TestCustomdiff_CustomDiff_OnLogin_Ugly(t *testing.T) {
	cd := NewCustomDiff(10000)
...
func TestCustomdiff_CustomDiff_Apply_Good(t *testing.T) {
...
func TestCustomdiff_CustomDiff_Apply_Bad(t *testing.T) {
	// target tokens: CustomDiff Apply
	// target symbol: CustomDiff_Apply
	cd := NewCustomDiff(10000)
...
func TestCustomdiff_CustomDiff_Apply_Ugly(t *testing.T) {
	// target tokens: CustomDiff Apply
	// target symbol: CustomDiff_Apply
	cd := NewCustomDiff(10000)
	miner := &Miner{user: "WALLET"}
