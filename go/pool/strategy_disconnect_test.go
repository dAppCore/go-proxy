...
func TestStrategyDisconnect_FailoverStrategy_Disconnect_Good(t *testing.T) {
	spy := &disconnectSpy{}
...
func TestStrategyDisconnect_FailoverStrategy_Disconnect_Bad(t *testing.T) {
	spy := &disconnectSpy{}
...
func TestStrategyDisconnect_FailoverStrategy_Disconnect_Ugly(t *testing.T) {
	spy := &disconnectSpy{}
	strategy := &FailoverStrategy{
		listener: spy,
		client:   &StratumClient{listener: nil},
...
func TestStratumClient_NotifyDisconnect_ClearsState_Good(t *testing.T) {
	// target tokens: NotifyDisconnect ClearsState
	// target symbol: NotifyDisconnect_ClearsState
...
func TestStratumClient_HandleMessage_LoginErrorDisconnects_Ugly(t *testing.T) {
	// target tokens: HandleMessage LoginErrorDisconnects
	// target symbol: HandleMessage_LoginErrorDisconnects
	spy := &disconnectSpy{}
	client := &StratumClient{
		listener: spy,
	...
	payload, err := testJSONMarshal(map[string]any{
		"id":      1,
		"jsonrpc": "2.0",
