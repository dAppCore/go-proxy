...
func TestStrategy_NewFailoverStrategy_Good(t *testing.T) {
...
func TestStrategy_NewFailoverStrategy_Bad(t *testing.T) {
...
func TestStrategy_NewFailoverStrategy_Ugly(t *testing.T) {
...
func TestStrategy_FailoverStrategy_Submit_Good(t *testing.T) {
	conn := &tickConn{}
...
func TestStrategy_FailoverStrategy_Submit_Bad(t *testing.T) {
	var strategy *FailoverStrategy
...
func TestStrategy_FailoverStrategy_Submit_Ugly(t *testing.T) {
...
func TestStrategy_FailoverStrategy_ReloadPools_Bad(t *testing.T) {
	var strategy *FailoverStrategy
...
func TestStrategy_FailoverStrategy_IsActive_Good(t *testing.T) {
...
func TestStrategy_FailoverStrategy_IsActive_Bad(t *testing.T) {
	var strategy *FailoverStrategy
	if strategy.IsActive() {
...
func TestStrategy_FailoverStrategy_IsActive_Ugly(t *testing.T) {
...
func TestStrategy_FailoverStrategy_Tick_Good(t *testing.T) {
	conn := &tickConn{}
...
func TestStrategy_FailoverStrategy_Tick_Bad(t *testing.T) {
	var strategy *FailoverStrategy
	strategy.Tick(60)
	if strategy != nil {
		t.Fatal("expected nil strategy to remain nil")
...
func TestStrategy_FailoverStrategy_Tick_Ugly(t *testing.T) {
	conn := &tickConn{}
	client := &StratumClient{config: proxy.PoolConfig{Keepalive: true}, conn: conn, active: true}
	strategy := &FailoverStrategy{client: client}
	strategy.Tick(59)
...
func TestStrategy_FailoverStrategy_OnJob_Good(t *testing.T) {
	spy := &strategyListenerSpy{}
	strategy := &FailoverStrategy{listener: spy}
	strategy.OnJob(proxy.Job{JobID: "job-1"})
	if got := spy.jobs.Load(); got != 1 {
...
func TestStrategy_FailoverStrategy_OnJob_Bad(t *testing.T) {
	var strategy *FailoverStrategy
	strategy.OnJob(proxy.Job{JobID: "job-1"})
	if strategy != nil {
		t.Fatal("expected nil strategy to remain nil")
...
func TestStrategy_FailoverStrategy_OnJob_Ugly(t *testing.T) {
	strategy := &FailoverStrategy{}
	strategy.OnJob(proxy.Job{})
	if strategy.listener != nil {
...
func TestStrategy_FailoverStrategy_OnResultAccepted_Good(t *testing.T) {
	spy := &strategyListenerSpy{}
	strategy := &FailoverStrategy{listener: spy}
	strategy.OnResultAccepted(7, true, "")
	if got := spy.results.Load(); got != 1 {
...
func TestStrategy_FailoverStrategy_OnResultAccepted_Bad(t *testing.T) {
	var strategy *FailoverStrategy
	strategy.OnResultAccepted(7, true, "")
	if strategy != nil {
		t.Fatal("expected nil strategy to remain nil")
...
func TestStrategy_FailoverStrategy_OnResultAccepted_Ugly(t *testing.T) {
	strategy := &FailoverStrategy{}
	strategy.OnResultAccepted(0, false, "Low difficulty share")
	if strategy.listener != nil {
		t.Fatalf("expected missing listener unchanged, got %+v", strategy.listener)
...
func TestStrategy_FailoverStrategy_OnDisconnect_Good(t *testing.T) {
	spy := &strategyListenerSpy{}
	strategy := &FailoverStrategy{listener: spy}
	strategy.OnDisconnect()
	if got := spy.disconnects.Load(); got != 1 {
...
func TestStrategy_FailoverStrategy_OnDisconnect_Bad(t *testing.T) {
	var strategy *FailoverStrategy
	strategy.OnDisconnect()
	if strategy != nil {
		t.Fatal("expected nil strategy to remain nil")
...
func TestStrategy_FailoverStrategy_OnDisconnect_Ugly(t *testing.T) {
	strategy := &FailoverStrategy{closing: true}
	strategy.OnDisconnect()
	if strategy.closing {
		t.Fatal("expected closing disconnect to clear closing flag")
