...
func TestKeepalive_StratumClient_Keepalive_Good(t *testing.T) {
...
func TestKeepalive_StratumClient_Keepalive_Bad(t *testing.T) {
	serverConn, clientConn := net.Pipe()
	defer serverConn.Close()
	defer clientConn.Close()
...
func TestKeepalive_StratumClient_Keepalive_Ugly(t *testing.T) {
	serverConn, clientConn := net.Pipe()
	defer serverConn.Close()
	defer clientConn.Close()
	...
	if err := testJSONUnmarshal(first, &firstPayload); err != nil {
		t.Fatalf("unmarshal first keepalive request: %v", err)
	}
	var secondPayload map[string]any
	if err := testJSONUnmarshal(second, &secondPayload); err != nil {
